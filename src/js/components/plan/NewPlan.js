...
export default class NewPlanForm extends React.Component {
  ...
  onFormSubmit(form) {
    TripleOApiService.createPlan(this.state.name, this.state.files).then(result => {
      NotificationActions.notify({
        title: 'Plan Created',
        message: 'The plan ' + this.state.name + ' was successfully created.',
        type: 'success'
      });
      this.props.history.pushState(null, 'plan/list');
    });
  }
        ...
        <div className="blank-slate-pf clearfix">
          ...
          <Formsy.Form ref="NewPlanForm"
            ...
            <div className="blank-slate-pf-main-action">
              <button disabled={!this.state.canSubmit} className="btn btn-primary btn-lg" type="submit">
