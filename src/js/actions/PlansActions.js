...
export default {
  ...
  fetchPlans() {
    return (dispatch, getState) => {
      ...
      TripleOApiService.getPlans(getAuthTokenId(getState())).then(response => {
  ...
  fetchPlan(planName) {
    return (dispatch, getState) => {
      ...
      TripleOApiService.getPlan(getAuthTokenId(getState()), planName).then(response => {
  ...
  deletePlan(planName) {
    return (dispatch, getState) => {
      ...
      history.pushState(null, '/plans/list');
      TripleOApiService.deletePlan(getAuthTokenId(getState()), planName).then(response => {
