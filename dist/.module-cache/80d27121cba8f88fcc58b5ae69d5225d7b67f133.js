    ...
    return (
      React.createElement("div", {className: "container"}, 
        React.createElement("div", {className: "row"}, 
          ...
          React.createElement(NodePicker, {nodeCount: 6, title: "Free"})
        )
      )
    );
  }
      ...
      React.createElement("div", {className: "panel panel-default"}, 
        ...
        React.createElement("div", {className: "panel-body"}, 
          React.createElement("div", {className: "row"}, 
            ...
            React.createElement("div", {className: "col-sm-6"}, 
              React.createElement(NodePicker, {nodeCount: this.props.flavor.freenodeCount, title: "Free"})
            )
          )
        )
      )
      ...
      React.createElement("div", {className: "panel panel-default role-panel " + this.props.role.name.toLowerCase()}, 
        React.createElement("div", {className: "panel-body"}, 
          ...
          React.createElement("div", {className: "pull-right"}, 
            React.createElement(NodePicker, {nodeCount: this.props.role.nodeCount, title: "Free"})
          )
        )
      )
    );
      ...
      return (
        React.createElement("div", {className: "node-box"}, 
          React.createElement("div", {className: "node-selector"}, 
            ...
            React.createElement(NodeStack, {title: this.props.title, nodeCount: this.props.nodeCount}), 
            React.createElement("button", {className: "btn btn-default btn-sm"}, 
