  ...
  render: function() {
    return (
      React.createElement("div", {className: "node-selector"}, 
        React.createElement(PickerArrow, {increment: updateCount.bind(this, -1)}), 
        React.createElement(NodeStack, {nodeCount: this.state.nodeCount}), 
        React.createElement("button", {className: "picker-arrow", onClick: this.updateCount.bind(this, 1)}, 
...
var PickerArrow = React.createClass({displayName: "PickerArrow",
  render: function() {
    return (
      React.createElement("button", {className: "picker-arrow", onClick: this.props.increment.bind(this, -1)}, 
