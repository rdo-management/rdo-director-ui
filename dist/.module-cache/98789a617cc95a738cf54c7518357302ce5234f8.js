...
var NodeStack = React.createClass({displayName: "NodeStack",
  render: function() {
    ...
    if(node_count <= 1) {
      ...
      return (
        React.createElement("div", null, 
          React.createElement("span", {class: "glyphicon glyphicon-chevron-left", "aria-hidden": "true"}), 
          React.createElement("div", {className: "node-stack-3"}, node_count), 
          React.createElement("span", {class: "glyphicon glyphicon-chevron-right", "aria-hidden": "true"}), 
